...
| Inventario | `Products`, `InventoryMovements`, `MonthlyRestockPlans` | Catálogo y existencias por movimientos. `MonthlyRestockPlans` permanece obsoleto solo para compatibilidad histórica. |
