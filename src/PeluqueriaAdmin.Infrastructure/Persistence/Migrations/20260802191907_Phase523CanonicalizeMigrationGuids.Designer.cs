...
namespace PeluqueriaAdmin.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260802191907_Phase523CanonicalizeMigrationGuids")]
    partial class Phase523CanonicalizeMigrationGuids
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeluqueriaAdmin.Domain.Finance.FinancialEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PeluqueriaAdmin.Domain.LocalUse.ChairAssignmentPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ChairId", "StartDate");

                    b.HasIndex("PersonId", "StartDate");

                    b.ToTable("ChairAssignmentPeriods", (string)null);
                });

            modelBuilder.Entity("PeluqueriaAdmin.Domain.LocalUse.DailyCharge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PersonId", "ChargeDate")
                        .IsUnique();

                    b.ToTable("DailyCharges", (string)null);
                });

            modelBuilder.Entity("PeluqueriaAdmin.Domain.LocalUse.DailyRate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long>("EffectiveFromUtc")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("EffectiveToUtc")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("EffectiveDate", "EffectiveFromUtc");
            ...
            modelBuilder.Entity("PeluqueriaAdmin.Domain.Settings.GeneralSettings", b =>
                {
                    ...
                    b.Property<bool>("IsDailyUsageFeeConfirmed")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("Settings", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Settings_WeeklyUsageFeeMinorUnits", "WeeklyUsageFeeMinorUnits IS NULL OR WeeklyUsageFeeMinorUnits >= 0");
                        });
                });
            ...
            modelBuilder.Entity("PeluqueriaAdmin.Domain.LocalUse.ChairAssignmentPeriod", b =>
                {
                    b.HasOne("PeluqueriaAdmin.Domain.LocalUse.Chair", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PeluqueriaAdmin.Domain.LocalUse.DailyCharge", b =>
                {
                    ...
                    b.HasOne("PeluqueriaAdmin.Domain.LocalUse.DailyRate", null)
                        .WithMany()
